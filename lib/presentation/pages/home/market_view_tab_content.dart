...
import 'package:rassi_clone/data/repositories/hot_issue_repository.dart';
...
class _MarketViewTabContentState extends State<MarketViewTabContent> {
  ...
  final _hotIssueRepository = HotIssueRepository();
      ...
      child: Column(
        children: [
          ...
          TodayHotIssueComponent(
            country: _selectedCountry,
            repository: _hotIssueRepository,
          ),
        ],
      ),
    );
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          TodayMarketComponent(repository: _marketRepository),
        ],
      ),
    );
  }
